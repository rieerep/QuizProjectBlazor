...
namespace BlazorQuiz.Server.Migrations
{
    ...
    [Migration("20231201122110_media column")]
    partial class mediacolumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorQuiz.Server.Models.GameModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorQuiz.Server.Models.GameModel", b =>
                {
                    ...
                    b.HasOne("BlazorQuiz.Server.Models.User", "Player")
                        .WithMany()
            ...
            modelBuilder.Entity("create_a_quiz.Server.Models.QuizModel", b =>
                {
                    b.HasOne("BlazorQuiz.Server.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlazorQuiz.Server.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
